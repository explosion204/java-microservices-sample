package com.epam.microserviceslearning.controller;

import com.epam.microserviceslearning.common.csv.CsvService;
import com.epam.microserviceslearning.service.SongMetadataService;
import com.epam.microserviceslearning.service.model.SongMetadataDto;
import com.epam.microserviceslearning.service.model.SongMetadataIdDto;
import com.epam.microserviceslearning.service.model.SongMetadataIdListDto;
...
public class SongController {
    ...
    @PostMapping
    public ResponseEntity<SongMetadataIdDto> createSongMetadata(@Valid @ModelAttribute SongMetadataDto songMetadataDto) {
    ...
    @DeleteMapping
    public ResponseEntity<SongMetadataIdListDto> delete(@RequestParam("id") String idsCsv) {
